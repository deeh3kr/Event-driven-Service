...
import static com.microservice.demo.elastic.query.service.constant.Constants.NA;
...
public class TwitterQueryUserJwtConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    private final com.microservice.demo.elastic.query.service.security.TwitterQueryUserDetailsService twitterQueryUserDetailsService;

    public TwitterQueryUserJwtConverter(com.microservice.demo.elastic.query.service.security.TwitterQueryUserDetailsService userDetailsService) {
    ...
    public AbstractAuthenticationToken convert(Jwt jwt) {
        ...
        return Optional.ofNullable(
                ...
                .map(userDetails -> {
                    ((com.microservice.demo.elastic.query.service.security.TwitterQueryUser) userDetails).setAuthorities(authoritiesFromJwt);

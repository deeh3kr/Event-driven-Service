...
import com.microservice.demo.common.util.CollectionsUtil;
import com.microservice.demo.elastic.model.index.impl.TwitterIndexModel;
import com.microservice.demo.elastic.query.client.exception.ElasticQueryClientException;
import com.microservice.demo.elastic.query.client.repository.TwitterElasticsearchQueryRepository;

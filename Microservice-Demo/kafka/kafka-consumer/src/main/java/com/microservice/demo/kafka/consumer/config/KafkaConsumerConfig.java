...
public class KafkaConsumerConfig<K extends Serializable, V extends SpecificRecordBase> {
    ...
    public KafkaConsumerConfig(KafkaConfigData kafkaData, KafkaConsumerConfigData kafkaConsumerData) {
        this.kafkaConfigData = kafkaData;
        this.kafkaConsumerConfigData = kafkaConsumerData;
    }
